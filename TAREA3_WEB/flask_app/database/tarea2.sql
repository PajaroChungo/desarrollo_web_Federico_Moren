-- Active: 1778285556064@@127.0.0.1@3306@mysql
...
CREATE TABLE IF NOT EXISTS `tarea2`.`miembro` (
  ...
  `tipo_miembro` ENUM('estudiante_pre', 'estudiante_post', 'funcionario', 'academico') NOT NULL,
  `cargo` ENUM('administrativo', 'profesional', 'coordinador', 'jefatura', 'auxiliar') NULL,
  PRIMARY KEY (`id`),
